		...
		<div id='banner' className='home'>
			<div className='banner'>
				<Slider {...settings}>
					...
					<img
						className='banner-3'
						src='https://res.cloudinary.com/danhpq17/image/upload/v1619885923/banner3_fqg5wr.jpg'
						alt='Banner 3'
					/>
				</Slider>
			</div>
			<div id='gioi-thieu' className='intro'>
				<div className='content'>
					<span className='title'>TRUNG TÂM BẢO HÀNH VÀ SỬA CHỮA TIVI SAMSUNG</span>
					<ul className='list-content'>
						<li>
							<img className='icon' src={require('../../assets/icon-1.png')} alt='icon' />
							TRUNG TÂM BẢO HÀNH VÀ SỬA CHỮA TIVI SAMSUNG chuyên cung cấp dịch vụ sửa , khắc phục
							các lỗi và hư hỏng tại nhà từ những sự cố nhỏ cho đến những hư hỏng nặng.
						</li>
						<li>
							<img className='icon' src={require('../../assets/icon-1.png')} alt='icon' />
							Chúng tôi sẽ cho kĩ thuật đến tận nhà kiểm tra và báo chi phí trước khi thực hiện sửa
							chữa. SAMSUNG thay thế linh kiện chính hãng chất lượng cao với giá rẻ phải chăng.
						</li>
						<li>
							<img className='icon' src={require('../../assets/icon-1.png')} alt='icon' />
			...
			<div id='gioi-thieu-part2' className='box-intro'>
				<img className='' src={require('../../assets/tivi.jpg')} alt='Tivi' />
				<div className='content'>
					...
					<ul className='list-content'>
						...
						<li>
							<h1>Hotline: 0888262052</h1>
						</li>
					</ul>
				</div>
			</div>
			<Container>
				<div id='sua-tivi-samsung' className='advantages'>
					<Title
						titleText={'LÝ DO NÊN CHỌN TRUNG TÂM BẢO HÀNH VÀ SỬA CHỮA SAMSUNG'}
			...
			<div id='lien-he' className='footer'>
				<Container>
					...
					<div className='hotline'>
						<span>Hotline: 0888262052</span>
					</div>
					<div className='location'>
						<div className='left'>
							<span className='subtitle'>TRUNG TÂM SỬA CHỮA – BẢO HÀNH TIVI SAMSUNG</span>
